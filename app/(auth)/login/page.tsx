    ...
    <>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
        ...
        .input:focus { border-color:rgba(232,255,71,0.4); background:rgba(255,255,255,0.06); }
        ...
        .forgot:hover { color:#e8ff47; }
        .submit-btn { width:100%; background:#e8ff47; color:#0a0a0b; border:none; border-radius:100px; padding:14px; font-size:15px; font-weight:700; font-family:'Nunito',sans-serif; cursor:pointer; margin-top:8px; transition:all 0.15s; letter-spacing:0.3px; box-shadow:0 0 20px rgba(232,255,71,0.25); }
        ...
        .footer a { color:#e8ff47; text-decoration:none; font-weight:500; }

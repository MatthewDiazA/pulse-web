    ...
    <>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
        ...
        .create-btn { background:#ED1465; color:#fff; font-size:13px; font-weight:700; padding:8px 16px; border-radius:100px; border:none; cursor:pointer; font-family:'Nunito',sans-serif; box-shadow:0 0 12px rgba(237,20,101,0.3); display:flex; align-items:center; gap:4px; transition:all 0.15s; }
        ...
        .stat-value.accent { color:#ED1465; text-shadow:0 0 8px rgba(237,20,101,0.3); }
        ...
        .section-header { display:flex; align-items:center; justify-content:space-between; margin-bottom:16px; padding-bottom:12px; border-bottom:0.5px solid rgba(255,255,255,0.08); }
        .section-title { font-size:11px; color:#555; letter-spacing:0.8px; text-transform:uppercase; font-family:'DM Sans',sans-serif; }
        ...
        .event-dot { width:7px; height:7px; border-radius:50%; background:#ED1465; flex-shrink:0; }
        ...
        .status-published { background:rgba(237,20,101,0.12); color:#ED1465; border:0.5px solid rgba(237,20,101,0.25); }
        ...
        .empty-btn { background:#ED1465; color:#fff; font-size:14px; font-weight:700; padding:12px 28px; border-radius:100px; border:none; cursor:pointer; font-family:'Nunito',sans-serif; box-shadow:0 0 16px rgba(237,20,101,0.3); }
      `}</style>
                ...
                {events.map((e) => {
                  ...
                  return (
                    <div key={e.id} className="bar-wrap">
                      <div className="bar" style={{height:`${pct}%`, background:'rgba(237,20,101,0.4)', border:'0.5px solid rgba(237,20,101,0.6)'}}/>

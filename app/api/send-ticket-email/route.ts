...
export async function POST(request: Request) {
  try {
    ...
    const venueRow = venue ? `<tr><td style="font-size:13px;color:#888;padding:6px 0;">Venue</td><td style="font-size:13px;color:#f0f0f0;text-align:right;padding:6px 0;">${venue}</td></tr>` : ''
